...
- Release Please owns the installer version, `Installer-<version>` tag, and GitHub Release. After it creates a release, the same workflow builds the exact released SHA and attaches the validated assets.
